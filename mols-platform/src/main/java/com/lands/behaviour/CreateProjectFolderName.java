...
public class CreateProjectFolderName implements NodeServicePolicies.OnCreateNodePolicy,NodeServicePolicies.OnUpdatePropertiesPolicy {
    ...
    public void init() {
        ...
        this.policyComponent.bindClassBehaviour(
            ...
            QName.createQName(ValuationModel.NAMESPACE_VALUATION_MODEL, ValuationModel.TYPE_PROJECT_REPORT_FOLDER),
            this.onCreateNode
        );
    ...
    public void createNameForNode(NodeRef nodeRef){
        ...
        if(nodeService.exists(nodeRef)){
            ...
            String name  = (String)nodeService.getProperty(nodeRef,QName.createQName(ValuationModel.NAMESPACE_VALUATION_MODEL , ValuationModel.PROP_PROJECT_NAME));
            String volume  = (String)nodeService.getProperty(nodeRef,QName.createQName(ValuationModel.NAMESPACE_VALUATION_MODEL, ValuationModel.PROP_PROJECT_VOLUME));
            String folder_name = name + ValuationModel.EXTRA_DIVIDER + volume;
