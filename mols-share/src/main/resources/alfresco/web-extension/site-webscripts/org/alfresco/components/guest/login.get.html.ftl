...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <@markup id="header">
         ...
         <div class="product-name">NAO EDRMS</div>
         <#--  <div class="product-tagline">Protecting Your Investments</div>  -->
         <#--  <div class="product-community">EDRMS</div>  -->
      </@markup>
      ...
      <@markup id="footer">
      <div class="login-copy"> &copy; NAO All rights reserved</div>
      </@markup>
   </@>
</@>